...
import os
from modelos import db, SensorSchema, Sensor, TipoSensor, Central, CentralSchema, Cliente, ClienteSchema, Evento, Ubicacion, UbicacionSchema, Scope, AuthorizatorLog, RequestLog
from vistas import VistaCentral, VistaClientesCentral, VistaUbicacionesCliente, VistaSensoresUbicacion, VistaEventosSensores, VistaNotificacion, VistaRequestLog
...
api.add_resource(VistaRequestLog, '/alarmrequest/<int:id_param>')
"""
...
with app.app_context():
    ...
    for i in range(10):
        ...
        list_scopes = ['WRITE','READ','NONE',]
        scope_tipo=random.choice(list_scopes)
        scope = Scope (action=scope_tipo)

        cl.scopes.append(scope);
